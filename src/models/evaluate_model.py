...
class ModelEvaluator:
    ...
    def calculate_prediction_intervals(self, y_pred: np.ndarray, residuals: np.ndarray,
    ...
    def cross_validation_score(self, model: Any, X: pd.DataFrame, y: pd.Series,
    ...
    def save_evaluation_results(self, results: Dict[str, Any], filename: str):
        ...
        serializable_results = {
            ...
            if k not in ['predictions', 'actuals', 'residuals']
        }
    ...
    def create_predictions_dataframe(self, y_true: np.ndarray, y_pred: np.ndarray,
                                    dates: pd.Series = None) -> pd.DataFrame:
        """

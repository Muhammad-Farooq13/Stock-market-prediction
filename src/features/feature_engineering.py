...
class FeatureEngineer:
    ...
    def create_moving_averages(self, df: pd.DataFrame, column: str, 
    ...
    def create_exponential_moving_averages(self, df: pd.DataFrame, column: str,
    ...
    def create_macd(self, df: pd.DataFrame, column: str,
    ...
    def create_bollinger_bands(self, df: pd.DataFrame, column: str,
        ...
        self.created_features.extend([upper_feature, lower_feature, width_feature, percentb_feature])
        logger.info(f"Created Bollinger Bands features for {column}")
        
        return df_features
    
    def create_price_changes(self, df: pd.DataFrame, column: str,
    ...
    def create_volatility_features(self, df: pd.DataFrame, column: str,
    ...
    def create_time_features(self, df: pd.DataFrame, date_column: str) -> pd.DataFrame:
        ...
        time_features = ['Year', 'Month', 'Day', 'DayOfWeek', 'Quarter', 
                        'WeekOfYear', 'IsMonthStart', 'IsMonthEnd']
        self.created_features.extend(time_features)
        
        logger.info("Created time-based features")
        return df_features
    
    def create_all_features(self, df: pd.DataFrame, price_column: str,
...
def main():
    ...
    # Example: df_features = engineer.create_all_features(df, price_column='Close', date_column='Date')

...
class TestDataPreprocessor:
    ...
    def test_handle_outliers(self):
        ...
        assert df_clean["A"].max() < 100  # Outlier should be capped
    ...
    def test_encode_categorical(self):
        ...
        assert "A" not in df_encoded.columns  # Original column removed
        assert df_encoded.shape[1] > df.shape[1]  # New columns added
